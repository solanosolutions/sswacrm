...
| `029_ss_api_keys_secure_access.sql` | RPCs restritas para gestão de API keys sem exposição de `key_hash` | CRM-SS-015, CRM-SS-016 | Validada em 03/08/2026 | Aplicada em 03/08/2026 | Não autorizado |
